...
Projeto de Trabalho acadêmico de uma API REST para gerenciar alunos, endereços e suas relações com cursos, turmas e disciplinas. A API usa Entity Framework Core para persistência e segue uma arquitetura simples com Controllers, Models e DTOs.
...
Projeto de trabalho acadêmico — usa licença do MIT.
